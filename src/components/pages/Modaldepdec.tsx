...
export const Modaldepdec: React.SFC<Ajout_utiliformprops> = ({ onclose, Datec, Montant, Lastcaisse, Endcaisse, Observation, Numcompte }) => {
    useEffect(() => {
                ...
                <IonContent fullscreen>
                    <IonList lines="full" class="ion-no-margin">
                        ...
                        <IonItem>
                            ...
                            <IonCol className="nereide" size="6">
                                {new Intl.NumberFormat("de-DE", { style: "currency", currency: "XOF" }).format(Montant)}
                            </IonCol>
                        ...
                        <IonItem>
                            ...
                            <IonCol className="nereide" size="6">
                                {new Intl.NumberFormat("de-DE", { style: "currency", currency: "XOF" }).format(Lastcaisse)}
                            </IonCol>
                        ...
                        <IonItem>
                            ...
                            <IonCol className="nereide" size="6">
                                {new Intl.NumberFormat("de-DE", { style: "currency", currency: "XOF" }).format(Endcaisse)}
                            </IonCol>
